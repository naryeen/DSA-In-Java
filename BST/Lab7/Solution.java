  ...
  /*************************************************************************
    ...
    ***************************************************************************/
    ...
    public static void main(String[] args) {
        ...
        Solution<String, Integer> str = new Solution<String, Integer>();
        ...
        String f1 = str.floor("HRITIK");
        System.out.println(f1);
        String f2 = str.floor("HAHA");
        System.out.println(f2);
        String s1 = str.select(2);
        System.out.println(s1);



        for (String s : str.keys())
            System.out.print(s+ " ");
